...
function AdminEvaluation() {
    ...
    const adoptRequest = useLocation();
    ...
    useEffect(()  => {
        setAdoptInfo(adoptRequest.state);
        console.log(adoptRequest.state)
        axios.post('http://localhost:3000/admin/evaluation/acc',{
            email: adoptRequest.state.email,
        })
        .then(res=>
            setaccInfo(res.data[0]))
        .catch(err=>console.log(err));

        axios.post('http://localhost:3000/admin/evaluation/pet',{
            id: adoptRequest.state.pet_id,
        })
        .then(res=>
    ...
    const Submit = () => {
        axios.post('http://localhost:3001/admin/setStatus',{
        ...
        <div className="adminEvaluation">
            ...
            <div className="mainContent">
                <div className="applicantInfoHeader">
                    ...
                    <p>Application Date: {adoptRequest.state.dates}</p>
                    <div className="appStatus">
                        <p>Application Status: </p>
                        <p className="appStatusVal">{adoptRequest.state.status}</p>
                    </div>
                </div>
                ...
                <div className="evalResultCont">
                    ...
                    <button onClick={()=> Submit()} className="evalSubmitButton">Submit</button>
                </div>
            </div>
        </div>
    );
