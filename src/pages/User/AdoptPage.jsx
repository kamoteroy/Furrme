						...
						<div className="adoptionVerification">
							...
							<div className="inputContainer">
								...
								<div className="inputWarningWrapper">
									...
									></textarea>
									{errors.household && (
										<span className="warningInside">{errors.household}</span>
									)}
								</div>
								...
								<div className="inputWarningWrapper">
									...
									></textarea>
									{errors.employment && (
										<span className="warningInside">{errors.employment}</span>
									)}
								</div>
								<p className="charCount">
								...
								<p className="respDisclaimer">
									The way your responses are asked are in a way that allows you
									to describe your situation and intentions in your own words
									while being comfortable on what to disclose and whatnot but
									please do note that this will be the primary reference on the
									approval of your adoption application.
								</p>
							</div>
								...
								>
									...
									<div className="commitmentHeader">
										...
										<p>
											...
											terms and conditions regarding the adoption and care of
											the pet:
										</p>
									</div>
									<h4>1. Understanding Pet Lifespan and Needs:</h4>
									<p>
										You are aware of the potential lifespan and specific needs
										of the pet you wish to adopt. This includes dietary
										requirements, exercise needs, grooming, and medical care.
									</p>
									...
									<p>
										...
										providing food, medical care, and attention throughout the
										pet's life.
									</p>

									<h4>3. Behavioral Issues:</h4>
									<p>
										You understand that pets may exhibit behavioral issues such
										as chewing, scratching, or barking. You are prepared to
										address these issues with patience and appropriate training.
									</p>

									<h4>4. Rehoming:</h4>
									<p>
										If you can no longer keep the pet for any reason, you agree
										to notify the adoption agency immediately. You will work
										with the agency to rehome the pet responsibly.
									</p>
									...
									<p>
										...
										regarding pet ownership, including licensing and vaccination
										requirements.
									</p>
									...
									<p>
										...
										adoption agency to ensure the pet's continued well-being.
										This helps the agency ensure that the pet is thriving in its
										new environment.
									</p>

									<h4>8. Agency Rights:</h4>
									<p>
										You understand that the adoption agency reserves the right
										to deny or revoke the adoption if the terms and conditions
										are not met. This ensures that the best interests of the pet
									...
									<p>
										...
										utmost confidentiality. Your information will be accessible
										only to authorized personnel involved in the adoption
										evaluation process, including adoption coordinators,
										volunteers, and relevant staff members.
									</p>

									<h4>3. Non-Distribution Policy:</h4>
									<p>
										Your personal information will not be sold, exchanged,
										transferred, or given to any other company or individual for
										any reason whatsoever, without your consent, other than for
										the express purpose of evaluating your adoption application.
									</p>

									<h4>4. Data Security:</h4>
									<p>
										We implement a variety of security measures to maintain the
										safety of your personal information. Your data will be
										stored in a secure environment to prevent unauthorized
									...
									<p>
										...
										individuals to verify the information provided and to
										discuss your suitability as a pet adopter. Your references
										will also be treated with confidentiality and will not be
										used for any purpose other than to assist in the evaluation
										of your application.
									</p>
									...
									<p>
										...
										provide consent for us to keep your details on file for
									...
									<p>
										...
										information we hold about you and to request corrections if
										necessary. If you wish to withdraw your application, you may
										do so at any time by contacting us. Upon withdrawal, your
										information will be promptly removed from our records.
									</p>
